 ...
 * <p>
 * - take the first page content
 * - using google's libphonenumber library to extract phone numbers
...
public class PhoneNumberExtractor implements Extractor {
  ...
  private static Optional<String> findFirstPhoneNumber(String content) {
    ...
    for (String line : lines) {
      Iterable<PhoneNumberMatch> numbers = phoneNumberUtil.findNumbers(line, "US");
