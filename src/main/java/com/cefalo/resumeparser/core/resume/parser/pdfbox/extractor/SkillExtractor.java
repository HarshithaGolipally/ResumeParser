package com.cefalo.resumeparser.core.resume.parser.pdfbox.extractor;
...
public class SkillExtractor implements Extractor {
  ...
  private static final Set<String> SKILL_SET = new HashSet<>(Arrays.asList(
          "Java", "Python", "Project Management", "Data Analysis", "Machine Learning",
          "SQL", "Communication", "Leadership", "Time Management", "Teamwork",
          "JavaScript", "React", "Angular", "Django", "Spring", "Node.js"
